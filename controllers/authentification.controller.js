...
const authentifierSecurite = async (request, response) => {
    const { login, password, portails } = request.body;

    const utilisateur = await authentificationService.authSecurite(login, password, portails);
